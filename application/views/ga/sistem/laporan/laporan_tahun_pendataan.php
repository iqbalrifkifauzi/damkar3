					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-edit"></i>Laporan Pembayaran Sptrd</div>
								<div class="tools">
								...
								<table class="table table-striped table-hover table-bordered" id="sample_editable_1">
									...
									<tbody>
										...
										if ($data_bayar->num_rows()>0) {
											foreach ($data_bayar->result_array() as $tampil) { ?>
										<tr >
											<td><?php echo $no;?></td>
											<td><?php echo $tampil['imb_id'];?></td>
											<td><?php echo $tampil['id_perpanjangan_retribusi'];?></td>
											<td><?php echo $tampil['tanggal_perpanjang_retribusi'];?></td>
