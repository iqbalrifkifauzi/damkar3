...
--
-- Host: 127.0.0.1
-- Generation Time: May 10, 2020 at 05:38 AM
...
INSERT INTO `tbl_perpanjang_retribusi` (`id_perpanjangan_retribusi`, `tanggal_perpanjang_retribusi`, `bulan_retribusi`, `imb_id`, `master_login_id`, `status`) VALUES
...
(28, '2020-04-22', '0000-00-00', 195, 0, ''),
(29, '2020-04-22', '0000-00-00', 198, 0, '');
...
CREATE TABLE IF NOT EXISTS `tbl_sptrd` (
  ...
  `uraian_retribusi` int(11) NOT NULL,
...
(190, 'imb 5', 'hotel iqbal', 'bekasi utara', 'hotel arjuna', 3, 'hotel', '2020', '123000', 0, '1325146531', 'depan kali', 'rifki', '2020-04-06', 1, 500000),
(191, 'imb 4', 'bank kampus', 'bekasi barat', 'gunadarma', 2, 'kampus', '2020', '321', 0, '123141', 'depan kali', 'sugeng', '2020-04-06', 1, 520000),
(192, 'imb 3', 'bank iqbal', 'bekasi timur', 'bank mandiri', 1, 'perbankan ', '2020', '120', 0, '123432', 'depan kant', 'yanyan', '2020-04-06', 1, 120000),
(193, 'imb 2', 'iqbal santika ', 'medan satria', 'santika', 5, 'hotel', '2020', '1200', 0, '123', 'depan kant', 'yitno', '2021-04-06', 1, 12000),
(194, 'imb 1', 'saepul', 'jl raya medan satria bekasi', 'majestik', 5, 'toko roti', '2020', '120', 0, '02100110011001', 'depan kali', 'indra', '2021-04-06', 1, 320000),
(195, '123RENAME', 'RENAME', 'RENAME', 'edit', 9, 'RENAME', '2020', '123', 0, 'RENAME123', 'RENAME', 'RENAME', '2020-04-06', 1, 2020),
(196, '1214641641433weubyn46ytuw', 'kecamatanasdfraw', 'kecamatan', 'kecamatanasasa', 11, 'kecamatanaafdsfdafad', '2020', '124415415', 0, '123214521', 'kecamatan', 'kecamatanawdfrqgrq', '2020-04-06', 0, 2147483647),
(197, 'nyoba perpanjang', 'kecamatanasdfraw', 'kecamatan', 'kecamatanasasa', 10, 'kecamatanaafdsfdafad', '2020', '124415415', 0, '123214521', 'kecamatan', 'kecamatanawdfrqgrq', '2020-04-06', 0, 2147483647),
(198, '12151653367', 'iqbal aja ', 'bekasi', 'update kecamatan', 1, 'apa aja bisa', '2020', '3582946582376502', 0, '1231541516', 'kecamatan ', 'IQBAL NYOBA KECAMATAN ', '2020-04-06', 1, 2147483647);
...
--
ALTER TABLE `tbl_perpanjang_retribusi`
  MODIFY `id_perpanjangan_retribusi` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=30;
--
